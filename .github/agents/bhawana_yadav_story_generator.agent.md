...
Types `@story-generator` in GitHub Copilot Chat, or
Uses the slash command `/generate-stories`, or
Selects text in the editor and invokes "Generate User Stories" from the Copilot context menu.
...
📋 Requirements Analysis Summary
🗂️ Epics Overview (if applicable)
